...
export class MatchService {
  ...
  async findAlltan(filter:Filter):Promise<any>{
    return this.matchModel.db.collection('MatchView').find().toArray()
  }


  //desprolijo
  async Desprolijo(filter: Filter): Promise<FilterResponse<Match>> {
